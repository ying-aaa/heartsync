...
@Component({
  selector: 'hs-source-card-list',
  templateUrl: './source-card-list.component.html',
  styleUrl: './source-card-list.component.less',
  imports: [
    DatePipe,
    MatMenuModule,
    MatIconModule,
...
export class SourceCardListComponent implements OnInit, OnDestroy {
