...
import { DB_RESERVED_KEYWORDS } from './table-name.validator';
 ...
 * 4. 不能是数据库保留关键字
 */
@ValidatorConstraint({ name: 'validFieldName', async: false })
export class ValidFieldNameValidator implements ValidatorConstraintInterface {
